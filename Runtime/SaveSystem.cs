...
namespace ACTools.Saving
{
    public static class SaveSystem
    {
        ...
        public static void SaveDataToBinaryFile<T>(string projectName, string dataName, T data)
        {
        ...
        public static T LoadDataFromBinaryFile<T>(string projectName, string dataName)
        {
            string path = Application.persistentDataPath + "/" + projectName + "." + dataName;
